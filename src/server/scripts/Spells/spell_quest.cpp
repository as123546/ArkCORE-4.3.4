...
{
    NPC_FROSTGIANT = 29351, NPC_FROSTWORG = 29358, SPELL_FROSTGIANT_CREDIT = 58184, SPELL_FROSTWORG_CREDIT = 58183, SPELL_IMMOLATION = 54690, SPELL_ABLAZE = 54683,
};
...
public:
    spell_q12851_going_bearback () :
            SpellScriptLoader("spell_q12851_going_bearback")
    {
    }
...
enum eWhoarethey
{
    ...
    SPELL_MALE_DISGUISE = 38080, SPELL_FEMALE_DISGUISE = 38081, SPELL_GENERIC_DISGUISE = 32756
};
...
public:
    spell_q10041_q10040_who_are_they () :
            SpellScriptLoader("spell_q10041_q10040_who_are_they")
    {
    }
...
public:
    spell_symbol_of_life_dummy () :
            SpellScriptLoader("spell_symbol_of_life_dummy")
    {
    }
...
public:
    spell_q12659_ahunaes_knife () :
            SpellScriptLoader("spell_q12659_ahunaes_knife")
    {
    }
...
{
    NPC_VILLAGER_KILL_CREDIT = 18240, SPELL_FLAMES = 39199,
};
...
public:
    spell_q9874_liquid_fire () :
            SpellScriptLoader("spell_q9874_liquid_fire")
    {
    }
...
public:
    spell_q12805_lifeblood_dummy () :
            SpellScriptLoader("spell_q12805_lifeblood_dummy")
    {
    }
...
{
    SUMMON_ANGRY_KVALDIR = 66737, SUMMON_NORTH_SEA_MAKO = 66738, SUMMON_NORTH_SEA_THRESHER = 66739, SUMMON_NORTH_SEA_BLUE_SHARK = 66740
};
...
public:
    spell_q14112_14145_chum_the_water () :
            SpellScriptLoader("spell_q14112_14145_chum_the_water")
    {
    }
    ...
    class spell_q14112_14145_chum_the_water_SpellScript: public SpellScript
    {
        ...
        void HandleScriptEffect (SpellEffIndex /*effIndex*/)
        {
            ...
            caster->CastSpell(caster, SUMMON_ANGRY_KVALDIR, true);
            caster->CastSpell(caster, SUMMON_NORTH_SEA_MAKO, true);
            caster->CastSpell(caster, SUMMON_NORTH_SEA_THRESHER, true);
            caster->CastSpell(caster, SUMMON_NORTH_SEA_BLUE_SHARK, true);
        }
...
{
    SPELL_CAST_NET = 29866, ITEM_RED_SNAPPER = 23614, NPC_ANGRY_MURLOC = 17102,
};
...
public:
    spell_q9452_cast_net () :
            SpellScriptLoader("spell_q9452_cast_net")
    {
    }
