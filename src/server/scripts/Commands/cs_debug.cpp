...
public:
    debug_commandscript () :
            CommandScript("debug_commandscript")
    {
    }
    ...
    static bool HandleDebugGetItemStateCommand (ChatHandler* handler, const char* args)
    {
        ...
        else if (state_str == "changed")
            state = ITEM_CHANGED;
        else if (state_str == "new")
            state = ITEM_NEW;
        else if (state_str == "removed")
            state = ITEM_REMOVED;
        else if (state_str == "queue")
            list_queue = true;
        else if (state_str == "check_all")
            check_all = true;
        else
            return false;
