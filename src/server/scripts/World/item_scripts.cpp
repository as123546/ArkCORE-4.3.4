...
public:
    item_only_for_flight () :
            ItemScript("item_only_for_flight")
    {
    }
...
public:
    item_nether_wraith_beacon () :
            ItemScript("item_nether_wraith_beacon")
    {
    }
...
public:
    item_gor_dreks_ointment () :
            ItemScript("item_gor_dreks_ointment")
    {
    }
...
public:
    item_incendiary_explosives () :
            ItemScript("item_incendiary_explosives")
    {
    }
...
public:
    item_mysterious_egg () :
            ItemScript("item_mysterious_egg")
    {
    }
...
public:
    item_disgusting_jar () :
            ItemScript("item_disgusting_jar")
    {
    }
...
enum ePileFakeFur
{
    GO_CARIBOU_TRAP_1 = 187982, GO_CARIBOU_TRAP_2 = 187995, GO_CARIBOU_TRAP_3 = 187996, GO_CARIBOU_TRAP_4 = 187997, GO_CARIBOU_TRAP_5 = 187998, GO_CARIBOU_TRAP_6 = 187999, GO_CARIBOU_TRAP_7 = 188000, GO_CARIBOU_TRAP_8 = 188001, GO_CARIBOU_TRAP_9 = 188002, GO_CARIBOU_TRAP_10 = 188003, GO_CARIBOU_TRAP_11 = 188004, GO_CARIBOU_TRAP_12 = 188005, GO_CARIBOU_TRAP_13 = 188006, GO_CARIBOU_TRAP_14 = 188007, GO_CARIBOU_TRAP_15 = 188008, GO_HIGH_QUALITY_FUR = 187983, NPC_NESINGWARY_TRAPPER = 25835
};

#define CaribouTrapsNum 15
const uint32 CaribouTraps[CaribouTrapsNum] =
{ GO_CARIBOU_TRAP_1, GO_CARIBOU_TRAP_2, GO_CARIBOU_TRAP_3, GO_CARIBOU_TRAP_4, GO_CARIBOU_TRAP_5, GO_CARIBOU_TRAP_6, GO_CARIBOU_TRAP_7, GO_CARIBOU_TRAP_8, GO_CARIBOU_TRAP_9, GO_CARIBOU_TRAP_10, GO_CARIBOU_TRAP_11, GO_CARIBOU_TRAP_12, GO_CARIBOU_TRAP_13, GO_CARIBOU_TRAP_14, GO_CARIBOU_TRAP_15, };

class item_pile_fake_furs: public ItemScript
{
public:
    item_pile_fake_furs () :
            ItemScript("item_pile_fake_furs")
    {
    }
...
{
    SPELL_PETROV_BOMB = 42406, AREA_ID_SHATTERED_STRAITS = 4064, ZONE_ID_HOWLING = 495
};
...
enum TheEmissary
{
    QUEST_THE_EMISSARY = 11626, NPC_LEVIROTH = 26452
};
...
public:
    item_trident_of_nazjan () :
            ItemScript("item_Trident_of_Nazjan")
    {
    }
...
enum eCapturedFrog
{
    QUEST_THE_PERFECT_SPIES = 25444, NPC_VANIRAS_SENTRY_TOTEM = 40187
};
